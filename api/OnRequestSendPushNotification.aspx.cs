...
public partial class OnRequestSendPushNotification : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (result != "")
            {
                ...
                // System Log
                SystemLog log = new SystemLog(key, "OnRequestSendPushNotification.aspx", "request send push notification", "true");
            ...
            else
            {
                ...
                // System Log
                SystemLog log = new SystemLog(key, "OnRequestSendPushNotification.aspx", "request send push notification", "false", result);
                LogController.WriteToLog(Server.MapPath(Config.Resource_SystemLog), log);
            }
        }
        catch (Exception ex)
        {
            ...
            // System Log
            SystemLog log = new SystemLog(key, "OnRequestSendPushNotification.aspx", "request send push notification", "false", ex.Message);
            LogController.WriteToLog(Server.MapPath(Config.Resource_SystemLog), log);
        }
